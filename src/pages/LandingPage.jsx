...
function App() {
  ...
  const faqs = [
    {
      question: 'ما هي خدمة مقيم؟',
      answer: 'تتيح خدمة مقيم للمنشآت الاطلاع على بيانات موظفيها المقيمين وإتمام معاملات الجوازات الخاصة بهم إلكترونياً وبشكل فوري.'
    },
    {
      question: 'كيف يمكنني الاشتراك؟',
      answer: 'يمكنك تعبئة نموذج الاشتراك في صفحة "خدمة مقيم" أو التواصل معنا مباشرة عبر الواتساب لإتمام الإجراءات.'
    },
    {
      question: 'هل تقدمون حلول برمجية خاصة؟',
      answer: 'نعم، نقوم بتصميم وتطوير أنظمة خاصة، مواقع، وتطبيقات جوال حسب متطلبات نشاطك التجاري.'
    }
  ];
  ...
  return (
    <div className="app bg-mesh">
      ...
      <section className="faq-section-white">
        <div className="container">
          <div className="section-header fade-in-up">
            <h2 className="section-title text-dark">الأسئلة <span className="text-gradient-accent">الأكثر شيوعاً</span></h2>
            <p className="section-desc text-gray">كل ما تحتاج لمعرفته حول خدماتنا وحلولنا التقنية</p>
          </div>
